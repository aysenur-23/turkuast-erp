...
const Auth = () => {
  ...
  return (
    <div className="h-screen w-full overflow-y-auto bg-[radial-gradient(circle_at_center,#ffffff_0%,#f1f5f9_100%)]">
      <div className="min-h-full w-full flex items-start sm:items-center justify-center p-4 sm:p-6 text-[#0f172a]">
